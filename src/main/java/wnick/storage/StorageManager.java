package wnick.storage;

import wnick.NameTagPlugin;
import wnick.storage.impl.LocalNameTagStorage;
...
public class StorageManager {
   ...
   /**
    * Reflectively load {@code wnick.storage.impl.MongoDBNameTagStorage}.
    *
   ...
   private NameTagStorage loadMongoStorage() {
      try {
         ...
         Class<?> mongoStorageClass = Class.forName(
            "wnick.storage.impl.MongoDBNameTagStorage",
            true,
